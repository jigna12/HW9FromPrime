 ...
 */
public class Pro_7_FirstAndLastDigitSum {
    public static int sumFirstAndLastDidit(int number){
        if (number < 0){
            return  -1;
        }
        int r, rev = 0, fd,Id,s;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The sum of first&last digit is:" + sumFirstAndLastDidit(a));
